...
<label><font size="5"><u><center>Laporan Data Buku</center></u></font></label>
...
<table style="border: 1px solid gray;" width="100%" cellpadding="0" cellspacing="0">
	<tr>
		...
		<th style="border-right: 1px solid gray">Penulis</th>
		<th style="border-right: 1px solid gray">Penerbit</th>
	...
	<?php
		...
		<tr>
			...
			<td align="center" style="border-right: 1px solid gray; border-top: 1px solid gray; padding: 3px 5px;" ><?php echo"$rs[kd_buku]"; ?></td>
			<td style="border-right: 1px solid gray; border-top: 1px solid gray; padding: 3px 5px;"><?php echo"$rs[judul_buku]"; ?></td>
			<td style="border-right: 1px solid gray; border-top: 1px solid gray; padding: 3px 5px;"><?php echo"$rs[penulis]"; ?></td>
			<td style="border-right: 1px solid gray; border-top: 1px solid gray; padding: 3px 5px;"><?php echo"$rs[penerbit]"; ?></td>
			...
			<td style="border-right: 1px solid gray; border-top: 1px solid gray; padding: 3px 5px;"><?php echo"$rs[kat]"; ?></td>
		</tr>
	<?php $no++;	}
	?>
</table>
