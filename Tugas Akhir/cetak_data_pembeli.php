...
<label><font size="5"><u><center>Laporan Data Pembeli</center></u></font></label>
...
<table style="border: 1px solid gray;" width="100%" cellpadding="0" cellspacing="0">
	...
	<?php
		...
		<tr>
			...
			<td align="center" style="border-right: 1px solid gray; border-top: 1px solid gray; padding: 3px 5px;" ><?php echo"$rs[nm_pembeli]"; ?></td>
		</tr>
	<?php $no++;	}
	?>
</table>
