<?php  
   ...
   if (isset($_POST['btn-save'])) {
    ...
    if ($brg->insertData($tgl_masuk, $merk, $nm_barang, $stok, $harga)) {
...
<div class="panel-body">
    ...
    <form method='post'>
        <table class='table table-bordered'>
          <tr>
                <td>Tanggal Masuk</td>
                <td><input type='text' name='tgl_masuk' class='form-control' required maxlength="50"></td>
            </tr>
            <tr>
                <td>Merk</td>
                <td><input type='text' name='merk' class='form-control' required maxlength="50"></td>
            </tr>

            <tr>
                <td>Nama Barang</td>
                <td><input type='text' name='nm_barang' class='form-control' required maxlength="50"></td>
            </tr>
